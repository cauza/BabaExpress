...
<div class="flex-center position-ref full-height">
    <div class="content container-xl">
					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="{{ route('driver.post_login') }}" method="post" id="contactForm" novalidate="novalidate">
  							@csrf
                            ...
                            <div class="col-md-12 form-group links"><a href="#">Lupa Password ?</a> <hr> <a href="{{ route('driver.register') }}">Buat Akun Baru</a></div>
						</form>
					</div>
    </div>
</div>
